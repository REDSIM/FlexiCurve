...
namespace Flexicurve {
    ...
    public class SimpleBezierWireMesh : BezierWireMesh {
        ...
        public SimpleBezierWireMesh() { }

        public SimpleBezierWireMesh(Vector3 a, Vector3 b, float sag, float radius, float spacing, int edges, float decimation, bool closedSides = true) {
