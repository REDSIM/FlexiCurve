...
namespace Flexicurve {
    ...
    public class BezierWireMesh : FlexiMeshBase {
        ...
        public BezierWireMesh() { }

        public BezierWireMesh(BezierCurve curve, float radius, float spacing, int edges, float decimation, bool closedSides = true) {
            Curve = curve;
            Radius = radius;
            Edges = edges;
            Spacing = spacing;
        ...
        public BezierWireMesh(Vector3 a, Vector3 b, float sag, float radius, float spacing, int edges, float decimation, bool closedSides = true) {
